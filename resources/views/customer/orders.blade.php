	                		...
	                		<div class="col-md-8 col-lg-9">
                                ...
                                <table class="table table-cart table-mobile">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="{{ route('customer.order.details', $order->id) }}"><span class="fw-semibold">#{{ $order->order_no }}</span></a></td>
                                            <td>{{ $order->created_at->format('d M Y, H:i') }}</td>
                                            <td>{{ $order->order_type }}</td>
                                            <td>{!! $site_settings->currency_symbol ?? '£' !!}{{ number_format($order->total_price, 2) }}</td>
                                            <td>
                                                @php
